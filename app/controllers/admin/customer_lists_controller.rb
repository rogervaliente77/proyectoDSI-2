module Admin
  class CustomerListsController < ApplicationController
    ...
    def destroy
      ...
      redirect_to admin_customer_lists_path, notice: "Lista eliminada correctamente."
    end
    ...
    # Extrae los clientes seleccionados y construye el arreglo de objetos [{ id: ..., email: ... }]
